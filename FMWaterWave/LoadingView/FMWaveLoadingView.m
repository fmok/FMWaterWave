...
typedef NS_ENUM(NSInteger, FMWavePathType) {
    FMWavePathType_Sin,
    FMWavePathType_Cos
};
...
@implementation FMWaveLoadingView

+ (instancetype)loadingView
{
    return [[FMWaveLoadingView alloc] initWithFrame:CGRectMake(0, 0, 40, 31)];
}
...
- (void)updateWave:(CADisplayLink *)displayLink
{
    ...
    self.waveSinLayer.path = [self createWavePathWithType:FMWavePathType_Sin].CGPath;
    self.waveCosLayer.path = [self createWavePathWithType:FMWavePathType_Cos].CGPath;
}


- (UIBezierPath *)createWavePathWithType:(FMWavePathType)pathType
{
